...
% x,y,yd,v are evaluated. p is simbolic scalar evaluated in the ode1 function
%

% FP is a function of the averaged rhs of the adjoint equation
% w.r. to v
%
FP = @(xx,p) interp1(x,Avg_FP(Fp,nu,x,y,yd,v,p),xx);
...
%
for i=1:length(x)
    E_Fp(i) =  nu(i,:)*Fp(x(i),y(i),yd(i),p,v')*dv;
end
