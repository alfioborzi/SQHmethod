...
%see corresponding paper, Subsection 4.5 for details

function [y] = forward_y(u,A,OCP)
%Solves the state equation of an elliptic linear equation with zero boundary conditions, see
%corresponding paper, Subsection 4.5 for details
