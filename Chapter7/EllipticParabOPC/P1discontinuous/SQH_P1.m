...
% square [0,a]x[0,b] - discontinuous cost
%
...
OCP=struct('N',99,'a',0,'b',1,'u_lo',-100,'u_up',100,'alpha',10^-10,'beta',10^-3,'s',10); 
...
%  title('The state variable');
  ...
  print('-depsc2', 'ellP12y.eps','-b0'); 
% print('-dpdf', 'ellP12y.pdf','-b0');
...
%  title('The control variable');
  ...
  print('-depsc2', 'ellP12u.eps','-b0'); 
% print('-dpdf', 'ellP12u.pdf','-b0');
...
%  title('Contour of the control variable');
  ...
  print('-depsc2', 'ellP12ucontour.eps','-b0'); 
% print('-dpdf', 'ellP12ucontour.pdf','-b0');
...
% title('Convergence history of J');
  ...
  print('-depsc2', 'ellP12Jhist.eps','-b0'); 
% print('-dpdf', 'ellP12Jhist.pdf','-b0');
