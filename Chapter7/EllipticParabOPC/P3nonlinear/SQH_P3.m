...
disp(' ');
%
% solving a nonlinear elliptic optimal control problem 
% on a square [0,a]x[0,b] - L2, L1, discontinuous costs
%
...
OCP=struct('N',99,'a',0,'b',1,'u_lo',-100,'u_up',100,'alpha',1*10^-10,'beta',1*10^-3,'s',10); % Problem specific parameters, N+1 number of intervals for the discretisation, a,b interval length of the domain, u_lo and u_up lower and upper bound for the control, alpha (weight quadratic cost term), beta and s (weight discontinuous cost term) cost functional parameters
...
%  title('The state variable');
  ...
  print('-depsc2', 'ellP3y.eps','-b0'); 
% print('-dpdf', 'ellP3y.pdf','-b0');
...
%  title('The control variable');
  ...
  print('-depsc2', 'ellP3u.eps','-b0'); 
% print('-dpdf', 'ellP3u.pdf','-b0');
...
%  title('Contour of the control variable');
  ...
  print('-depsc2', 'ellP3ucontour.eps','-b0'); 
% print('-dpdf', 'ellP3ucontour.pdf','-b0');
...
% title('Convergence history of J');
 ...
 print('-depsc2', 'ellP3Jhist.eps','-b0'); 
% print('-dpdf', 'ellP3Jhist.pdf','-b0');
